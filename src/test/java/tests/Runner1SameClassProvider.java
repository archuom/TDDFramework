...
public class Runner1SameClassProvider 
{
	...
	public Object[][] method2()
	{
		Object[][] data = new Object[][] {
			{"firefox","","blank","2404","valid","mbno is blank"},
			{"firefox","9878","invalid","2404","valid","mbno size is wrong"},
			{"firefox","9848756269","valid","2404","valid","valid detials"}
		};
		return(data);
	}
